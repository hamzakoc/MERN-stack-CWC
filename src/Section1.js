...
import {
  ...
  CarouselIndicators,
  CarouselCaption,
  Card, Button, CardImg, CardTitle, CardText, CardColumns,CardGroup, CardFooter,
...
<div class="row  ">
        ...
        herhangi bir şekilde veya hiçbir şekilde yargılamayı veya 
          ...
          <div class="col-md-5 ">
          <img      alt="..."    className="img-responsive"     src={require("./component/images/neyapiyoruz.png")}
    style={{ width: "100%" }} />
          </div>
</div>
       ...
       <br></br><br></br><br></br>
        ...
        <img  alt="..."  className="img-responsive"
            src={require("./component/images/education.jpg")}
            style={{ width: "100%" }}
          />
        ...
        <br></br><br></br><br></br>
          ...
          src={require("./component/images/entegrasyon.jpg")}
          style={{ width: "100%" }}
        />
                </div>
            </div>
